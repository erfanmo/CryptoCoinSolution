...
{
    public partial class frm_NorouziStrategy : Form
    {

        ServiceOperation serviceOperation = null;

        public frm_NorouziStrategy(ServiceOperation _serviceOperation)
        {
            InitializeComponent();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            //-- Mandatory
            paramList.Add("Name=" + "SampleStrategyNorouzi");
            paramList.Add("StrategyName=" + "NorouziStrategy");
