...
{
    public partial class frm_SafiStrategy : Form
    {

        ServiceOperation serviceOperation = null;

        public frm_SafiStrategy(ServiceOperation _serviceOperation)
        {
            InitializeComponent();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            //-- Mandatory
            paramList.Add("Name=" + "SampleStrategySafi");
            paramList.Add("StrategyName=" + "SafiStrategy");
