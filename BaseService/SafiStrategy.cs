...
{
    public class SafiStrategy : BaseStrategy
    {

        public SafiStrategy(Dictionary<string, string> parameters, string name, string basePath) : base(parameters, name, basePath)
        {
