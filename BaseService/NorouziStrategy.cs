...
{
    public class NorouziStrategy : BaseStrategy
    {

        public NorouziStrategy(Dictionary<string, string> parameters, string name, string basePath) : base(parameters, name, basePath)
        {
